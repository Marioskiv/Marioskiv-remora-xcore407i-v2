...
**Evidence:**
```bash
$ grep -c "Type.*Encoder" config_6axis_closed_loop.json
8
```
...
**Evidence:**
```bash
$ grep -c "Type.*Endstop" config_6axis_closed_loop.json
8
```
...
**Evidence:**
```bash
$ grep -c "Type.*Alarm" config_6axis_closed_loop.json
8
```
...
4. **config_6axis_closed_loop.json** - Full 6-axis configuration
...
Use: `examples/config_6axis_closed_loop.json`
- Load full 6-axis configuration
...
### Configuration Files
✓ `config_6axis_closed_loop.json` (318 lines)
