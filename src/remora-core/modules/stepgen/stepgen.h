...
private:
	...
	volatile int32_t* ptrStepCount;		/**< Pointer for stepgen count (separate from encoder feedback) */
...
public:
	...
	Stepgen(int32_t _threadFreq, int _jointNumber, const char* _enable, const char* _step, const char* _direction, int _stepBit, volatile int32_t &_ptrFrequencyCommand, volatile int32_t &_ptrStepCount, volatile uint8_t &_ptrJointEnable, bool _usesModulePost);
