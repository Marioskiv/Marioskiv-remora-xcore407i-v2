...
enum class RemoraErrorSource : uint8_t {
    ...
    POSITION_MON  = (0x05 << 4), // 0x50 - Position monitoring errors
};
...
enum class RemoraErrorCode : uint8_t {
    ...
    // POSITION_MON
    POSITION_ERROR_EXCEEDED   = 0x01,  // Following error too large
    STEP_LOSS_DETECTED        = 0x02,  // Missed steps detected
    ENCODER_MISMATCH          = 0x03,  // Encoder/stepgen mismatch
    VELOCITY_ERROR            = 0x04,  // Velocity deviation
};
